    ...
    *,
    ...
    if not npz_path:
        ...
        return {
            ...
            "canonical_reference_source": manifest.get("canonical_reference_source"),
            ...
            "resolved_selected_ghost_rank": manifest.get("resolved_selected_ghost_rank"),
            "resolved_selected_ghost_name": manifest.get("resolved_selected_ghost_name"),
            "author_fallback_used": bool(manifest.get("author_fallback_used", False)),
            "intended_bundle_manifest_path": manifest.get("intended_bundle_manifest_path"),
            "exploit_bundle_manifest_path": manifest.get("exploit_bundle_manifest_path"),
            "selected_override_manifest_path": manifest.get("selected_override_manifest_path"),
            "author_fallback_manifest_path": manifest.get("author_fallback_manifest_path"),
